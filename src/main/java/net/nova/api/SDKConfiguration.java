...
import net.nova.api.utils.AsyncHooks;
import net.nova.api.utils.HTTPClient;
import net.nova.api.utils.Hooks;
...
public class SDKConfiguration {
    ...
    public static final String OPENAPI_DOC_VERSION = "0.6.4";
    public static final String SDK_VERSION = "0.0.1";
    public static final String GEN_VERSION = "2.884.4";
    private static final String BASE_PACKAGE = "net.nova.api";
