...
/**
 * Spring Boot Configuration Properties for nova-java SDK
 */
@ConfigurationProperties(prefix = "novajava")
public class NovaJavaAutoConfigProperties {

    /**
     * Constructor.
     */
    public NovaJavaAutoConfigProperties() {
    }
    ...
    public static class RetryConfig {
         ...
         */
        private net.nova.api.utils.RetryConfig.Strategy strategy;
         ...
         */
        public net.nova.api.utils.RetryConfig.Strategy getStrategy() {
            return strategy;
        }
         ...
         */
        public void setStrategy(net.nova.api.utils.RetryConfig.Strategy strategy) {
